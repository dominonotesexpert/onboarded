...
function convertRoutesToDataRoutes(routes, mapRouteProperties3, parentPath, manifest) {
  ...
  return routes.map((route, index) => {
    ...
    if (isIndexRoute(route)) {
      let indexRoute = _extends({}, route, mapRouteProperties3(route), {
        id
      });
      manifest[id] = indexRoute;
      return indexRoute;
    } else {
      let pathOrLayoutRoute = _extends({}, route, mapRouteProperties3(route), {
        id,
        children: void 0
      });
      manifest[id] = pathOrLayoutRoute;
      if (route.children) {
        pathOrLayoutRoute.children = convertRoutesToDataRoutes(route.children, mapRouteProperties3, treePath, manifest);
      }
...
function createRouter(init) {
  ...
  let mapRouteProperties3;
  if (init.mapRouteProperties) {
    mapRouteProperties3 = init.mapRouteProperties;
  } else if (init.detectErrorBoundary) {
    let detectErrorBoundary = init.detectErrorBoundary;
    mapRouteProperties3 = (route) => ({
      hasErrorBoundary: detectErrorBoundary(route)
    });
  } else {
    mapRouteProperties3 = defaultMapRouteProperties;
  }
  let manifest = {};
  let dataRoutes = convertRoutesToDataRoutes(init.routes, mapRouteProperties3, void 0, manifest);
  ...
  async function callDataStrategy(type, state2, request, matchesToLoad, matches, fetcherKey) {
    ...
    let dataResults = {};
    try {
      results = await callDataStrategyImpl(dataStrategyImpl, type, state2, request, matchesToLoad, matches, fetcherKey, manifest, mapRouteProperties3);
    } catch (e) {
      ...
      try {
        await patchRoutesOnNavigationImpl({
          ...
          patch: (routeId, children) => {
            if (signal.aborted)
              return;
            patchRoutesImpl(routeId, children, routesToUse, localManifest, mapRouteProperties3);
          }
        });
      } catch (e) {
        return {
  ...
  function _internalSetRoutes(newRoutes) {
    manifest = {};
    inFlightDataRoutes = convertRoutesToDataRoutes(newRoutes, mapRouteProperties3, void 0, manifest);
  }
  function patchRoutes(routeId, children) {
    let isNonHMR = inFlightDataRoutes == null;
    let routesToUse = inFlightDataRoutes || dataRoutes;
    patchRoutesImpl(routeId, children, routesToUse, manifest, mapRouteProperties3);
    if (isNonHMR) {
      dataRoutes = [...dataRoutes];
      updateState({});
    }
...
function createStaticHandler(routes, opts) {
  ...
  if (opts != null && opts.mapRouteProperties) {
    mapRouteProperties3 = opts.mapRouteProperties;
  ...
  let dataRoutes = convertRoutesToDataRoutes(routes, mapRouteProperties3, void 0, manifest);
  ...
  async function callDataStrategy(type, request, matchesToLoad, matches, isRouteRequest, requestContext, dataStrategy) {
    let results = await callDataStrategyImpl(dataStrategy || defaultDataStrategy, type, null, request, matchesToLoad, matches, null, manifest, mapRouteProperties3, requestContext);
    let dataResults = {};
...
function patchRoutesImpl(routeId, children, routesToUse, manifest, mapRouteProperties3) {
  ...
  let newRoutes = convertRoutesToDataRoutes(uniqueChildren, mapRouteProperties3, [routeId || "_", "patch", String(((_childrenToPatch = childrenToPatch) == null ? void 0 : _childrenToPatch.length) || "0")], manifest);
...
async function loadLazyRouteModule(route, mapRouteProperties3, manifest) {
  if (!route.lazy) {
    return;
  }
  ...
  Object.assign(routeToUpdate, _extends({}, mapRouteProperties3(routeToUpdate), {
    lazy: void 0
  }));
}
...
async function callDataStrategyImpl(dataStrategyImpl, type, state, request, matchesToLoad, matches, fetcherKey, manifest, mapRouteProperties3, requestContext) {
  let loadRouteDefinitionsPromises = matches.map((m) => m.route.lazy ? loadLazyRouteModule(m.route, mapRouteProperties3, manifest) : void 0);
...
init_router();
var DataRouterContext2 = /* @__PURE__ */ React3.createContext(null);
if (true) {
  DataRouterContext2.displayName = "DataRouter";
}
var DataRouterStateContext2 = /* @__PURE__ */ React3.createContext(null);
if (true) {
  DataRouterStateContext2.displayName = "DataRouterState";
}
var AwaitContext2 = /* @__PURE__ */ React3.createContext(null);
if (true) {
  AwaitContext2.displayName = "Await";
}
var NavigationContext2 = /* @__PURE__ */ React3.createContext(null);
if (true) {
  NavigationContext2.displayName = "Navigation";
}
var LocationContext2 = /* @__PURE__ */ React3.createContext(null);
if (true) {
  LocationContext2.displayName = "Location";
}
var RouteContext2 = /* @__PURE__ */ React3.createContext({
  outlet: null,
  matches: [],
  isDataRoute: false
});
...
var RouteErrorContext2 = /* @__PURE__ */ React3.createContext(null);
if (true) {
  RouteErrorContext2.displayName = "RouteError";
}
var START_TRANSITION3 = "startTransition";
var startTransitionImpl3 = React3[START_TRANSITION3];
var neverSettledPromise2 = new Promise(() => {
});
function mapRouteProperties2(route) {
  let updates = {
    // Note: this check also occurs in createRoutesFromChildren so update
    // there if you change this -- please and thank you!
    hasErrorBoundary: route.ErrorBoundary != null || route.errorElement != null
  ...
  if (route.Component) {
    ...
    Object.assign(updates, {
      element: /* @__PURE__ */ React3.createElement(route.Component),
      Component: void 0
    });
  }
  if (route.HydrateFallback) {
    ...
    Object.assign(updates, {
      hydrateFallbackElement: /* @__PURE__ */ React3.createElement(route.HydrateFallback),
      HydrateFallback: void 0
    });
  }
  if (route.ErrorBoundary) {
    ...
    Object.assign(updates, {
      errorElement: /* @__PURE__ */ React3.createElement(route.ErrorBoundary),
      ErrorBoundary: void 0
    });
  }
  return updates;
...
var RemixContext = /* @__PURE__ */ React9.createContext(void 0);
RemixContext.displayName = "Remix";
function useRemixContext() {
  let context = React9.useContext(RemixContext);
...
var NavLink2 = /* @__PURE__ */ React9.forwardRef(({
  to,
  prefetch = "none",
  discover = "render",
  ...props
  ...
  return /* @__PURE__ */ React9.createElement(React9.Fragment, null, /* @__PURE__ */ React9.createElement(NavLink, _extends4({}, props, prefetchHandlers, {
    ref: mergeRefs(forwardedRef, ref),
    to,
    "data-discover": getDiscoverAttr(discover, isAbsolute, props.reloadDocument)
  })), shouldPrefetch && !isAbsolute ? /* @__PURE__ */ React9.createElement(PrefetchPageLinks, {
    page: href
  }) : null);
});
NavLink2.displayName = "NavLink";
var Link2 = /* @__PURE__ */ React9.forwardRef(({
  to,
  prefetch = "none",
  discover = "render",
  ...props
  ...
  let href = useHref(to);
  let [shouldPrefetch, ref, prefetchHandlers] = usePrefetchBehavior(prefetch, props);
  return /* @__PURE__ */ React9.createElement(React9.Fragment, null, /* @__PURE__ */ React9.createElement(Link, _extends4({}, props, prefetchHandlers, {
    ref: mergeRefs(forwardedRef, ref),
    to,
    "data-discover": getDiscoverAttr(discover, isAbsolute, props.reloadDocument)
  })), shouldPrefetch && !isAbsolute ? /* @__PURE__ */ React9.createElement(PrefetchPageLinks, {
...
var Form2 = /* @__PURE__ */ React9.forwardRef(({
  discover = "render",
  ...props
}, forwardedRef) => {
  let isAbsolute = typeof props.action === "string" && ABSOLUTE_URL_REGEX3.test(props.action);
  return /* @__PURE__ */ React9.createElement(Form, _extends4({}, props, {
    ref: forwardedRef,
    "data-discover": getDiscoverAttr(discover, isAbsolute, props.reloadDocument)
  }));
});
...
function Links() {
  ...
  return /* @__PURE__ */ React9.createElement(React9.Fragment, null, criticalCss ? /* @__PURE__ */ React9.createElement("style", {
    ...
    key,
    link
  }) => isPageLinkDescriptor(link) ? /* @__PURE__ */ React9.createElement(PrefetchPageLinks, _extends4({
    key
  }, link)) : /* @__PURE__ */ React9.createElement("link", _extends4({
    key
  }, link))));
}
function PrefetchPageLinks({
  ...
  return /* @__PURE__ */ React9.createElement(PrefetchPageLinksImpl, _extends4({
    page,
    matches
  }, dataLinkProps));
}
...
function PrefetchPageLinksImpl({
  ...
  let newMatchesForData = React9.useMemo(() => getNewMatchesForLinks(page, nextMatches, matches, manifest, location, future, "data"), [page, nextMatches, matches, manifest, location, future]);
  ...
  let newMatchesForAssets = React9.useMemo(() => getNewMatchesForLinks(page, nextMatches, matches, manifest, location, future, "assets"), [page, nextMatches, matches, manifest, location, future]);
  let moduleHrefs = React9.useMemo(() => getModuleLinkHrefs(newMatchesForAssets, manifest), [newMatchesForAssets, manifest]);
  let keyedPrefetchLinks = useKeyedPrefetchLinks(newMatchesForAssets);
  return /* @__PURE__ */ React9.createElement(React9.Fragment, null, dataHrefs.map((href) => /* @__PURE__ */ React9.createElement("link", _extends4({
    key: href,
    rel: "prefetch",
    as: "fetch",
    href
  }, linkProps))), moduleHrefs.map((href) => /* @__PURE__ */ React9.createElement("link", _extends4({
    key: href,
    rel: "modulepreload",
    href
    ...
    /* @__PURE__ */ React9.createElement("link", _extends4({
      key
    }, link))
  )));
}
function Meta() {
  ...
  return /* @__PURE__ */ React9.createElement(React9.Fragment, null, meta.flat().map((metaProps) => {
    ...
    if ("tagName" in metaProps) {
      ...
      let Comp = tagName;
      return /* @__PURE__ */ React9.createElement(Comp, _extends4({
    ...
    return /* @__PURE__ */ React9.createElement("meta", _extends4({
...
function Await2(props) {
  return /* @__PURE__ */ React9.createElement(Await, props);
}
    ...
    contextScript += !activeDeferreds ? "" : ["__remixContext.p = function(v,e,p,x) {", "  if (typeof e !== 'undefined') {", true ? "    x=new Error(e.message);\n    x.stack=e.stack;" : '    x=new Error("Unexpected Server Error");\n    x.stack=undefined;', "    p=Promise.reject(x);", "  } else {", "    p=Promise.resolve(v);", "  }", "  return p;", "};", "__remixContext.n = function(i,k) {", "  __remixContext.t = __remixContext.t || {};", "  __remixContext.t[i] = __remixContext.t[i] || {};", "  let p = new Promise((r, e) => {__remixContext.t[i][k] = {r:(v)=>{r(v);},e:(v)=>{e(v);}};});", typeof abortDelay === "number" ? `setTimeout(() => {if(typeof p._error !== "undefined" || typeof p._data !== "undefined"){return;} __remixContext.t[i][k].e(new Error("Server timeout."))}, ${abortDelay});` : "", "  return p;", "};", "__remixContext.r = function(i,k,v,e,p,x) {", "  p = __remixContext.t[i][k];", "  if (typeof e !== 'undefined') {", true ? "    x=new Error(e.message);\n    x.stack=e.stack;" : '    x=new Error("Unexpected Server Error");\n    x.stack=undefined;', "    p.e(x);", "  } else {", "    p.r(v);", "  }", "};"].join("\n") + Object.entries(activeDeferreds).map(([routeId, deferredData]) => {
      ...
      let promiseKeyValues = deferredData.deferredKeys.map((key) => {
        if (pendingKeys.has(key)) {
          deferredScripts.push(/* @__PURE__ */ React9.createElement(DeferredHydrationScript, {
            key: `${routeId} | ${key}`,
            deferredData,
            routeId,
            dataKey: key,
...
import(${JSON.stringify(manifest.entry.module)});`;
    return /* @__PURE__ */ React9.createElement(React9.Fragment, null, /* @__PURE__ */ React9.createElement("script", _extends4({}, props, {
      suppressHydrationWarning: true,
      dangerouslySetInnerHTML: createHtml(contextScript),
      type: void 0
    })), /* @__PURE__ */ React9.createElement("script", _extends4({}, props, {
      suppressHydrationWarning: true,
...
function DeferredHydrationScript({
  ...
  return /* @__PURE__ */ React9.createElement(React9.Suspense, {
    fallback: (
      // This makes absolutely no sense. The server renders null as a fallback,
      // but when hydrating, we need to render a script tag to avoid a hydration issue.
      // To reproduce a hydration mismatch, just render null as a fallback.
      typeof document === "undefined" && deferredData && dataKey && routeId ? null : /* @__PURE__ */ React9.createElement("script", _extends4({}, scriptProps, {
        async: true,
        suppressHydrationWarning: true,
        dangerouslySetInnerHTML: {
          __html: " "
  ...
  }, typeof document === "undefined" && deferredData && dataKey && routeId ? /* @__PURE__ */ React9.createElement(Await2, {
    resolve: deferredData.data[dataKey],
    errorElement: /* @__PURE__ */ React9.createElement(ErrorDeferredHydrationScript, {
      dataKey,
      routeId,
      scriptProps,
      serializeError
    ...
    children: (data3) => {
      return /* @__PURE__ */ React9.createElement("script", _extends4({}, scriptProps, {
        async: true,
        suppressHydrationWarning: true,
        dangerouslySetInnerHTML: {
  ...
  }) : /* @__PURE__ */ React9.createElement("script", _extends4({}, scriptProps, {
    async: true,
    suppressHydrationWarning: true,
    dangerouslySetInnerHTML: {
      __html: " "
...
function RemixBrowser(_props) {
  ...
  let [criticalCss, setCriticalCss] = React10.useState(true ? window.__remixContext.criticalCss : void 0);
  if (true) {
    window.__remixClearCriticalCss = () => setCriticalCss(void 0);
  }
  let [location, setLocation] = React10.useState(router.state.location);
  ...
  return (
    ...
    /* @__PURE__ */ React10.createElement(React10.Fragment, null, /* @__PURE__ */ React10.createElement(RemixContext.Provider, {
      value: {
      ...
      location
    }, /* @__PURE__ */ React10.createElement(RouterProvider2, {
      router,
      fallbackElement: null,
      future: {
        v7_startTransition: true
      }
    }))), window.__remixContext.future.v3_singleFetch ? /* @__PURE__ */ React10.createElement(React10.Fragment, null) : null)
  );
}
...
function ScrollRestoration2({
  ...
  return /* @__PURE__ */ React11.createElement("script", _extends4({}, props, {
    suppressHydrationWarning: true,
    dangerouslySetInnerHTML: {
...
function RemixServer({
  ...
  return /* @__PURE__ */ React12.createElement(React12.Fragment, null, /* @__PURE__ */ React12.createElement(RemixContext.Provider, {
    value: {
      manifest,
      routeModules,
      criticalCss,
  ...
  }, /* @__PURE__ */ React12.createElement(import_server.StaticRouterProvider, {
    router: router2,
    context: context.staticHandlerContext,
    hydrate: false
  }))), context.future.v3_singleFetch && context.serverHandoffStream ? /* @__PURE__ */ React12.createElement(React12.Suspense, null, /* @__PURE__ */ React12.createElement(StreamTransfer, {
    context,
    identifier: 0,
...
@remix-run/react/dist/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=/build/_shared/chunk-ULZ26LME.js.map
