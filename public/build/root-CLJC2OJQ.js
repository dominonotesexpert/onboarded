...
// empty-module:~/lib/i18n.server
var require_i18n = __commonJS({
  "empty-module:~/lib/i18n.server"(exports, module) {
    module.exports = {};
  }
});
...
var QueryClientProvider = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(QueryClientContext.Provider, { value: client2, children });
};
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1763420485409.4558";
}
var i18nextClient = instance.createInstance();
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1763420491423.328";
}
var client = null;
...
var meta = () => [{
  ...
  title: "FlowForge \xB7 Visual Workflow Automation Engine"
}, {
  name: "description",
  content: "FlowForge is a production-ready visual workflow builder with real-time execution monitoring, built on Remix, Prisma, React Flow, and Effect."
}, {
  name: "viewport",
...
function App() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("html", { lang: data.locale, className: "bg-midnight text-slate-100", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("body", { className: "antialiased", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Providers, { locale: data.locale, translations: data.translations, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Outlet, {}, void 0, false, {
        fileName: "app/root.tsx",
        lineNumber: 90,
        columnNumber: 11
      }, this) }, void 0, false, {
...
function Providers({
  ...
  const [client2] = (0, import_react2.useState)(() => {
    const instance2 = i18nextClient.cloneInstance();
    applyTranslations(instance2, locale, translations);
    instance2.changeLanguage(locale);
    return instance2;
  });
  (0, import_react2.useEffect)(() => {
    applyTranslations(client2, locale, translations);
    client2.changeLanguage(locale);
  }, [client2, locale, translations]);
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(I18nextProvider, { i18n: client2, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(ToastProvider, { children }, void 0, false, {
    fileName: "app/root.tsx",
    lineNumber: 127,
    columnNumber: 9
  }, this) }, void 0, false, {
...
_s2(Providers, "Cb2cdrLbayOf3lOULhYeV0uWRX0=");
_c2 = Providers;
function applyTranslations(instance2, locale, translations) {
  Object.entries(translations ?? {}).forEach(([namespace, resource]) => {
    if (resource) {
      instance2.addResourceBundle(locale, namespace, resource, true, true);
    }
  });
}
var _c;
